...
cat links/11-13.1/wsj0/doc/indices/train/tr_l_wv1.ndx | \
 ...
 grep -v -i 11-4.1/wsj0/si_tr_s/430 > train_si84.flist

nl=`cat train_si84.flist | wc -l`
[ "$nl" -eq 1806 ] || echo "Warning: expected 1806 lines in train_si84.flist, got $nl"
: '
...
cp ../../../WSJ0_2015/11-13.1/wsj0/doc/lng_modl/base_lm/bcb20onp.z $lmdir/lm_bg.arpa.gz 
chmod u+w $lmdir/lm_bg.arpa.gz

# trigram would be:
cat ../../../WSJ0_2015/11-13.1/wsj0/doc/lng_modl/base_lm/tcb20onp.z | \
...
cp ../../../WSJ0_2015/11-13.1/wsj0/doc/lng_modl/base_lm/bcb05onp.z  $lmdir/lm_bg_5k.arpa.gz || exit 1;
chmod u+w $lmdir/lm_bg_5k.arpa.gz

# trigram would be: !only closed vocabulary here!
cp ../../../WSJ0_2015/11-13.1/wsj0/doc/lng_modl/base_lm/tcb05cnp.z $lmdir/lm_tg_5k.arpa.gz || exit 1;
